...
const DISCORD_INVITE_URL = 'https://discord.gg/UwtBDkmvSj';
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            ...
            <a
              ...
              className="flex items-center gap-2 px-8 py-4 border border-[#5865F2]/40 rounded-xl font-medium text-slate-300 hover:border-[#5865F2]/70 hover:text-foreground transition-all bg-[#5865F2]/10"
            >
            ...
            <div id="free-ebook" className="p-8 bg-[#13131A] border border-[#1F1F2E] rounded-3xl">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-400/90">En cours de création</p>
                </div>
              </div>

              <div className="relative mb-8">
                <div className="pointer-events-none select-none blur-[3px] opacity-55" aria-hidden>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="rounded-full border border-amber-500/30 bg-amber-500/15 px-4 py-2 text-sm font-semibold text-amber-200 backdrop-blur-sm">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full py-4 text-center border border-[#5865F2]/40 rounded-xl font-semibold text-[#c8d0ff] hover:border-[#5865F2]/70 hover:text-white transition-all cursor-pointer bg-[#5865F2]/15"
              >
                <IconDiscord className="w-5 h-5 text-[#5865F2]" />
                Rejoindre le Discord →
              </a>
